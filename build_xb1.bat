...
cmake -B build -DCMAKE_BUILD_TYPE=%BUILD_TYPE% -DSENTRY_BACKEND=none -DSENTRY_TRANSPORT=none -DCMAKE_GENERATOR_PLATFORM=Gaming.Xbox.XboxOne.x64 -DBUILD_SHARED_LIBS=ON -DCMAKE_SYSTEM_VERSION=10 -DSENTRY_WITH_LIBBACKTRACE=true
